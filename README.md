# MatSim dataset generation script: Generate images of random material oinside transparent containers random environments with a gradual transition between materials
